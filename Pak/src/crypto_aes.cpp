...
void CryptoAES::Init(const u8* key1_, const u8* key2_)
{
...
void CryptoAES::Key2AddOffset(u8* out, i32 offset)
{
...
void CryptoAES::ComputeXorBlock(u32* key)
{
	...
	u32 step1_0 = g_AES_1024_1_2[xor2 >> 0x10 & 0xff] ^ g_AES_1024_1_1[xor1 >> 8 & 0xff] ^ g_AES_1024_1_3[xor3 >> 0x18] ^ g_AES_1024_1_0[xor0 & 0xff] ^ exp1[4];
	u32 step1_1 = g_AES_1024_1_2[xor3 >> 0x10 & 0xff] ^ g_AES_1024_1_1[xor2 >> 8 & 0xff] ^ g_AES_1024_1_3[xor0 >> 0x18] ^ g_AES_1024_1_0[xor1 & 0xff] ^ exp1[5];
	u32 step1_2 = g_AES_1024_1_1[xor3 >> 8 & 0xff] ^ g_AES_1024_1_2[xor0 >> 0x10 & 0xff] ^ g_AES_1024_1_3[xor1 >> 0x18] ^ g_AES_1024_1_0[xor2 & 0xff] ^ exp1[6];
	u32 step1_3 = g_AES_1024_1_2[xor1 >> 0x10 & 0xff] ^ g_AES_1024_1_1[xor0 >> 8 & 0xff] ^ g_AES_1024_1_3[xor2 >> 0x18] ^ g_AES_1024_1_0[xor3 & 0xff] ^ exp1[7];
	...
	if(rounds != 2) {
		...
		do {
			xor0 = g_AES_1024_1_2[step1_2 >> 0x10 & 0xff] ^ g_AES_1024_1_1[step1_1 >> 8 & 0xff] ^ g_AES_1024_1_3[step1_3 >> 0x18] ^ g_AES_1024_1_0[step1_0 & 0xff] ^ exp1_p10[-2];
			xor2 = g_AES_1024_1_2[step1_3 >> 0x10 & 0xff] ^ g_AES_1024_1_1[step1_2 >> 8 & 0xff] ^ g_AES_1024_1_3[step1_0 >> 0x18] ^ g_AES_1024_1_0[step1_1 & 0xff] ^ exp1_p10[-1];
			xor1 = g_AES_1024_1_1[step1_3 >> 8 & 0xff] ^ g_AES_1024_1_2[step1_0 >> 0x10 & 0xff] ^ g_AES_1024_1_3[step1_1 >> 0x18] ^ g_AES_1024_1_0[step1_2 & 0xff] ^ *exp1_p10;
			xor3 = g_AES_1024_1_2[step1_1 >> 0x10 & 0xff] ^ g_AES_1024_1_1[step1_0 >> 8 & 0xff] ^ g_AES_1024_1_3[step1_2 >> 0x18] ^ g_AES_1024_1_0[step1_3 & 0xff] ^ exp1_p10[1];
			step1_0 = g_AES_1024_1_2[xor1 >> 0x10 & 0xff] ^ g_AES_1024_1_1[xor2 >> 8 & 0xff] ^ g_AES_1024_1_3[xor3 >> 0x18] ^ g_AES_1024_1_0[xor0 & 0xff] ^ exp1_p10[2];
			step1_1 = g_AES_1024_1_2[xor3 >> 0x10 & 0xff] ^ g_AES_1024_1_1[xor1 >> 8 & 0xff] ^ g_AES_1024_1_3[xor0 >> 0x18] ^ g_AES_1024_1_0[xor2 & 0xff] ^ exp1_p10[3];
			step1_2 = g_AES_1024_1_1[xor3 >> 8 & 0xff] ^ g_AES_1024_1_2[xor0 >> 0x10 & 0xff] ^ g_AES_1024_1_3[xor2 >> 0x18] ^ g_AES_1024_1_0[xor1 & 0xff] ^ exp1_p10[4];
			step1_3 = g_AES_1024_1_2[xor2 >> 0x10 & 0xff] ^ g_AES_1024_1_1[xor0 >> 8 & 0xff] ^ g_AES_1024_1_3[xor1 >> 0x18] ^ g_AES_1024_1_0[xor3 & 0xff] ^ exp1_p10[5];
	...
	*key = g_AES_1024_1_0[step1_2 >> 0x10 & 0xff] & 0xff0000 ^ g_AES_1024_1_3[step1_1 >> 8 & 0xff] & 0xff00 ^ g_AES_1024_1_1[step1_3 >> 0x18] & 0xff000000 ^ (u32)*(u8 *)(g_AES_1024_1_2 + (step1_0 & 0xff)) ^ exp1[rounds * 4];
	key[1] = g_AES_1024_1_0[step1_3 >> 0x10 & 0xff] & 0xff0000 ^ g_AES_1024_1_3[step1_2 >> 8 & 0xff] & 0xff00 ^ g_AES_1024_1_1[step1_0 >> 0x18] & 0xff000000 ^ (u32)*(u8 *)(g_AES_1024_1_2 + (step1_1 & 0xff)) ^ exp1[rounds * 4 + 1];
	key[2] = g_AES_1024_1_0[step1_0 >> 0x10 & 0xff] & 0xff0000 ^ g_AES_1024_1_3[step1_3 >> 8 & 0xff] & 0xff00 ^ g_AES_1024_1_1[step1_1 >> 0x18] & 0xff000000 ^ (u32)*(u8 *)(g_AES_1024_1_2 + (step1_2 & 0xff)) ^ exp1[rounds * 4 + 2];
	key[3] = g_AES_1024_1_0[step1_1 >> 0x10 & 0xff] & 0xff0000 ^ g_AES_1024_1_3[step1_0 >> 8 & 0xff] & 0xff00 ^ g_AES_1024_1_1[step1_2 >> 0x18] & 0xff000000 ^ (u32)*(u8 *)(g_AES_1024_1_2 + (step1_3 & 0xff)) ^ exp1[rounds * 4 + 3];
}

void CryptoAES::KeyAlteration(u8* key)
{
	u8* p = key + 0xf;
	*p += 1;
	i32 i = 0;
...
void CryptoAES::Decrypt(void* data, const int dataSize, const int dataOffsetFromStart)
{
